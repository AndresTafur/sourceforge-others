        ...
        _scn_mgr(_scn_mgr)
{
	...
	const std::set<Ogre::SceneQuery::WorldFragmentType> *supportedQueryTypes = (std::set<Ogre::SceneQuery::WorldFragmentType>*) _intersection_query->getSupportedWorldFragmentTypes();
