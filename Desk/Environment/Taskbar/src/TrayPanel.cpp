#include "TrayPanel.hh"
    ...
    void TrayPanel::getSelection()
    {
       char *atom_name = (char*) malloc( sizeof(char) *20  );
          ...
          gdk_property_change (GTK_WIDGET (this->GetHandle())->window, gdk_atom_intern ("_NET_SYSTEM_TRAY_ORIENTATION", false),gdk_atom_intern ("_NET_SYSTEM_TRAY_ORIENTATION", false), 32,
